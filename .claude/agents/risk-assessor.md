...
# Supersedes step manifest minimum for this step only.
...
The oversight-evaluator must read this file and use its `required_signoffs` list instead of (or merged with) the step manifest's list when the file exists and the step number matches.
