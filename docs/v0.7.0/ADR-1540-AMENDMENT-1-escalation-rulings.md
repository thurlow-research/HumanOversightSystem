...
> **AMENDED AGAIN 2026-09-15 — `docs/v0.7.0/ADR-1540-AMENDMENT-3-panel-rulings.md`.** The dual-lens adversarial panel ran and returned **`DO-NOT-BUILD`**; its findings are ruled in **Amendment 3** (AM-19 … AM-28, AF-8, AF-9). **Where Amendment 3 differs from Amendment 2 or from this document, Amendment 3 governs.** Two rulings below are directly affected: **AM-6**'s `/approve` disposition — the command's label write is now **made inert** in S2 (AM-25, overruling TD §9/R5, two of whose three stated reasons are false) — and **AM-13**'s held-everything line, which may no longer claim a completeness the gate's walk did not have (AM-20). **§3(b) H1 is superseded for the second time: the authoritative text is `ADR-1540-AMENDMENT-3` §3(b), which has FIVE items.** Do not quote H1 from this document or from Amendment 2.

**Date:** 2026-09-15 (original), amended 2026-09-15 (Amendments 2 and 3)
**Author:** architect
