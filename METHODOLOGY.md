...
- Turn-level raw log — append-only per-session record of every prompt/response pair. 🔧
- Session summaries + watermarks — periodic regenerable distillations; watermark lets a session stop/restart without losing context. 🔧
